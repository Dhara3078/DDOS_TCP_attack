...
def main():
    ...
    print("TCP Traffic with Minmax Scaling")
    print("="*60)
    
    # File paths
    model_path = "models/cnn_gru_model_PSO_TCP_12_aug_minmax_scaling.h5"
    x_test_path = "test_data/x_test_minmax_tcp_data.npy"
    y_test_path = "test_data/y_test_minmax_tcp_labels.npy"
    ...
    try:
        ...
        # Save results
        results_file = "inference_results_tcp_minmax.txt"
