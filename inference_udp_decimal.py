...
def main():
    ...
    print("UDP Traffic with Decimal Scaling")
    print("="*60)
    
    # File paths
    model_path = "models/cnn_gru_model_PSO_UDP_14_aug_decimal_scaling.h5"
    x_test_path = "test_data/x_test_decimal_udp_data.npy"
    y_test_path = "test_data/y_test_decimal_udp_labels.npy"
    ...
    try:
        ...
        # Save results
        results_file = "inference_results_udp_decimal.txt"
